...
1. ==British social anthropology==: Bronislaw Malinowski, Meyer Fortes
	...
	- [[Y1 T1 SOC Society/CONCEPTS/Gender\|Gender]]: the roles women were expected to follow was socializing the children and domestic labour, therefore excluding them from anthropological accounts.
...
2. ==French structural approach==: Claude Lévi-Strauss
	...
	- [[Y1 T1 SOC Society/CONCEPTS/Feminism\|Feminism]] - it was the men exchanging the women like 'supreme gifts' to ensure the reproduction of the group. Not true for all cultures, according to feminist scholars.
	...
	- The idea of [[Y1 T1 SOC Society/CONCEPTS/Marriage\|Marriage]] as a long-term exchange between families involving the transfer of goods, services and people. 
...
- When studying non-Western societies, they did not consider marriage as a defining feature of society, hence [[Y1 T1 SOC Society/CONCEPTS/Othering\|Othering]] them. 
- [[Y1 T1 SOC Society/PEOPLE/Karl Marx\|Karl Marx]]'s critique of the anthropological study of kinship: one household seen as a unit of production, and property seen as the basis for all relations.
- The constant forces of death and separation meant people focused more on forgetting than remembering.

[[Y1 T1 SOC Society/PEOPLE/David Schneider\|David Schneider]]'s role:
...
- Belonged to a tradition that saw kinship & culture like languages: by studying terminology used in a particular instance, one could reveal insights about the idea of kinship in that culture. 
	...
	- This is called ==symbolic interactionism==. [[Y1 T1 SOC Society/PEOPLE/Satish Deshpande\|Satish Deshpande]] talks about this in [[Y1 T1 SOC Society/READINGS/PRIMARY/SOC1.03 Deshpande, Contemporary India - A Sociological View\|SOC1.03 Deshpande, Contemporary India - A Sociological View]], about Edmund Husserl's perspective of [[Y1 T1 SOC Society/CONCEPTS/Commonsense\|Commonsense]]: the sharing of social meaning using symbols, gestures, etc. 
...
Post-Schneider
- [[Y1 T1 SOC Society/CONCEPTS/Feminism\|Feminism]] inspired the study of [[Y1 T1 SOC Society/CONCEPTS/Gender\|Gender]], but gender cannot be understood without understanding marriage, [[Y1 T1 SOC Society/CONCEPTS/Family\|Family]] structures, inheritance, beliefs about procreation, etc.
...
Links: [[Y1 T1 SOC Society/CONCEPTS/Kinship\|Kinship]]